...
import { getCurrentLocale, getIntlLocale, translateText } from './i18n';
...
function formatDate(timestamp) {
  ...
  if (date.toDateString() === now.toDateString()) {
    return translateText(locale, '今天');
  }
...
export const helpers = {
  COLOR_POOL, CATEGORY_TONES, getCategoryTone, getCategoryAccent,
  getLogoFallbackColor, formatDate, formatMonth, truncate, getDomain,
  recordResourceVisit, useViewportWidth,
};
export { useViewportWidth, getCategoryTone, getCategoryAccent, getLogoFallbackColor, formatDate, formatMonth, truncate, getDomain, recordResourceVisit, COLOR_POOL, CATEGORY_TONES };
