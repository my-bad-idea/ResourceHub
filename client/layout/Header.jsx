...
import { Search, Sun, Moon, Monitor, User, LogOut, Settings, Shield, ChevronDown, Languages } from 'lucide-react';
...
function Header({ variant = 'default', showSearch = true }) {
  ...
  const { locale, setLocale, locales, getNativeLabel } = useI18n();
