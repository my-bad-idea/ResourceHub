...
import { History, LayoutGrid, ShieldCheck, Languages, ChevronDown } from 'lucide-react';
...
function AuthLayout({ children }) {
  ...
  const { locale, setLocale, locales, getNativeLabel, t } = useI18n();
  const viewportWidth = useViewportWidth();
...
export { authStyles, AuthCard, AuthLayout };
